        ...
        <footer className="footer">
            <div className="footer-row">
                <div className="footer-col">
                    ...
                    <p className='footer-p'>Adopet is an animal adoption app created so that everyone can find an animal they love, love and care for wholeheartedly. Where the heart grows is where the fun is.</p>
                </div>
                <div className="footer-col">
                ...
                <div className="footer-col">
                    <h3>Find us <div className="underline"><span></span></div></h3>
